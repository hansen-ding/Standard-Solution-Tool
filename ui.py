...
with col_right:
    ...
    with power_col2:
        power_unit = st.selectbox("Unit", ["kW", "MW"], key='power_unit_select')
    
    # Capacity with unit
    capacity_col1, capacity_col2 = st.columns([2, 1])
    with capacity_col1:
    ...
    with capacity_col2:
        capacity_unit = st.selectbox("Unit", ["kWh", "MWh"], key='capacity_unit_select')
