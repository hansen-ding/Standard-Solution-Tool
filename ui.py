...
<style>
    ...
    @media print {{
        ...
        /* 第一页：Project Overview - 保持在一起 */
        .main-title:first-of-type,
        .subtitle:first-of-type {{
            page-break-after: avoid;
        }}
        
        /* 第二页：System Configuration - 新页开始 */
        #pcs-selection {{
            page-break-before: always;
            page-break-after: avoid;
        }}
        
        /* 第三页：Results & Analysis - 新页开始 */
        .main-title:has(+ .subtitle:contains("Capacity")) {{
            page-break-before: always;
        }}
        ...
        * {{
        ...
        /* Augmentation Plan 表格打印样式 */
        [data-testid="column"]:has(input[id^="aug_year_"]) {{
